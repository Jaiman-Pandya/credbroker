...
grant service and the invoke service, and maps broker domain errors onto
gRPC status codes. It never touches raw provider credentials — agents only
ever see signed grant tokens and tool results, which is the core invariant
of the broker.
"""
